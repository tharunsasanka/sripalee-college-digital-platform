...
export default function SiteFooterStatic() {
  return (
    <footer className="relative overflow-hidden bg-[#271716] px-5 pt-16 text-white lg:px-8">
      ...
      <div className="relative mx-auto grid max-w-7xl gap-10 border-b border-[#d6b55c]/20 pb-12 md:grid-cols-2 lg:grid-cols-4">
        <div className="lg:col-span-2">
          ...
          <p className="mt-7 max-w-xl text-sm leading-7 text-white/60">
            A secure, accessible and multilingual digital platform supporting
            the Sripalee College community, public information and school
            heritage.
          </p>
          ...
          <div className="mt-6 inline-flex items-center gap-2 rounded-full border border-[#d6b55c]/20 bg-white/5 px-4 py-2 text-sm text-white/65">
            ...
            Privacy-conscious and accessibility-focused
          </div>
        </div>
        ...
        <div>
          ...
          <div className="mt-5 space-y-4 text-sm leading-6 text-white/60">
            <p>Sripalee College, Horana, Sri Lanka</p>
            <p>Official telephone number pending confirmation</p>
            <p>Official email address pending confirmation</p>
          </div>
      ...
      <div className="relative mx-auto flex max-w-7xl flex-col gap-5 py-6 text-xs text-white/60 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <p>© 2026 Sripalee College Digital Platform.</p>

          <p className="mt-1 text-white/60">
            Digital platform development project
          </p>
