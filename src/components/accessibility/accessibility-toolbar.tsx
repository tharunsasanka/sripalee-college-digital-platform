...
export function AccessibilityToolbar() {
  ...
  const [settings, setSettings] = useState<AccessibilitySettings>(() => {
    try {
      ...
      if (savedSettings) {
        ...
        if (isAccessibilitySettings(parsedSettings)) {
  ...
  useEffect(() => {
    ...
    root.dataset.accessibilityContrast = String(settings.highContrast);
    root.dataset.accessibilityLinks = String(settings.underlineLinks);
    root.dataset.accessibilityMotion = String(settings.reducedMotion);
    root.dataset.accessibilityFont = String(settings.readableFont);
      ...
      {isOpen && (
        ...
        >
          <div className="flex items-start justify-between gap-4">
            ...
            <Accessibility className="text-[#741f2b]" size={25} />
          </div>

          <div className="mt-6 rounded-2xl bg-[#faf7ef] p-4">
            <div className="flex items-center gap-3">
              <ALargeSmall className="text-[#741f2b]" size={21} />
          ...
          <div className="mt-4 space-y-3">
            <PreferenceToggle
              ...
              description="Increase visual contrast across the main page content."
              icon={Contrast}
            ...
            <PreferenceToggle
              ...
              description="Minimise animations, transitions and smooth scrolling."
              icon={Move}
          ...
          <Link
            ...
            className="focus-ring mt-3 inline-flex w-full items-center justify-center gap-2 rounded-full bg-[#4e111b] px-5 py-3 font-semibold text-white"
          >
            <Eye size={18} />
  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        <Icon className="mt-0.5 shrink-0 text-[#741f2b]" size={20} />

        <div>
          <p className="font-semibold text-[#4e111b]">{title}</p>
